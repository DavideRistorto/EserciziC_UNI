...
public class DynamicStack{ 
  ...
  private Node top; 
  //punta all’ultimo ultimo nodo aggiunto alla pila, contiene null se non ci sono nodi

 /* Tutti i metodi di DynamicStack devono preservare il seguente invariante di classe: ogni nodo tranne il primo punta all’elemento precedente, e il campo top di  punta al primo elemento della pila. */
...
//tolgo il nodo in cima alla pila e restituisco il suo contenuto 
 ...
 /* Per scorrere una pila usiamo una variabile di tipo Node che parte da top e procede lungo la pila fino a arrivare al nodo null. Usiamo di nuovo una conversione Node-->String. */
