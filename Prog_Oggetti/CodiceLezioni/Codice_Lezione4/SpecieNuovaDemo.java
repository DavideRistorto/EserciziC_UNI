...
modifica sia sensata. */
 public void setSpecie(String n, int p, double t){
  ...
  /** Per ottenere gli attributi della classe ora e' necessario un metodo "get". Se un dato e' riservato, basta togliere il suo metodo “get” e l’attributo non e' piu' accessibile dall’esterno della classe. */
...
/** Questo metodo dinamico assegna gli attributi di this agli attribuiti dell’oggetto "altraSpecie" passato come argomento.*/
...
/** Dobbiamo aggiungere un metodo per confrontare due oggetti: usare direttamente == tra gli oggetti non va sempre bene, perche' == confronta gli indirizzi dei due oggetti, invece qui vogliamo confrontare i valori dei attributi */
...
public class SpecieNuovaDemo { //classe eseguibile pubblica
  ...
  /** Questo metodo ferma l’esecuzione del programma e aspetta un a capo per continuare. E' statico, quindi non viene invocato su un oggetto, ma chiamato scrivendo: SpecieNuovaDemo.pause(); 
In realtà, poiché in questo esempio viene invocato all’interno della classe stessa, possiamo invocarlo direttamente così: pause(); */
...
public static void main(String[] args){
 ...
 /** Non possiamo assegnare nome, popolazione e tasso di crescita direttamente perche' questi attributi sono privati */
