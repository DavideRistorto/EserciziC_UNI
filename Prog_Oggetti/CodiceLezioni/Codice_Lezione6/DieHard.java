...
/** Non costruiamo oggetti per DieHard (non avrebbe senso). Dunque, i metodi di DieHard sono dichiarati statici e non vengono chiamati su oggetti della classe (si veda nel main()).*/
