...
public class Stack {
  ...
  public Stack(int capacity) {
     ...
     * Questa condizione, in particolare, dovrà essere gestita in modo che il
     * programma non fallisca a runtime se vengono inseriti dati sbagliati. A tal
     * fine impareremo a usare il meccanismo delle 'eccezioni'. Per ora, ci
     * concentriamo a trovare i casi in cui un programma potrebbe fallire a runtime
     * e usiamo le assert come primo meccanismo per segnalare questi casi di errore
