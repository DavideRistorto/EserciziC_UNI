...
/** Specie e' una classe non eseguibile per rappresentare delle specie di esseri viventi. Scriveremo un programma per sperimentare Specie in una classe di nome SpecieDemo, e salveremo tutto nel file: SpecieDemo.java */
class Specie { 
...
scomparsi. In realta' sono diventati irraggiungibili: non ho piu' il  loro indirizzo. Java dopo un poco ricicla le aree di memoria irraggiungibili, che a questo punto spariscono davvero (tramite un processo che gira in parallelo con il nostro programma, detto Garbage Collector). */